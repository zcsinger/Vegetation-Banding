...
Depending on how much vegetation/water we started with, both cases show that there's an interesting pattern where the vegetation and water concentrations move up the hill as a block with a speed *s*.
