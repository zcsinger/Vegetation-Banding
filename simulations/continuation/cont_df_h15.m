...
% the model system detailed below with Tangent Continuation: 
...
function [f, J] = cont_df_h15(u, N, dx, b_old, b_oldx, M, D)
...
Jbc1t = 0;
Jbc2t = -[b_plus_dt s*b_plus_dt] * stab_eval';
...
% disp(['size of Jbc4: ' num2str(size(Jbc4))])
