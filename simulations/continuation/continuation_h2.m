...
% Mode Input
m = input(['Enter a mode (0/1 = debug, 2 = single comp, ' ...
            '3 = init. cont, 4 = tang., 5 = tran, 6 = fig): ']);
...
filename_std = 's_theta_81517_std_h2m_01.txt';
filename_bv = 's_theta_81517_bv_h2m_01.txt';
...
%%%%%%%%%%%%%%%%%%% SCALING AND DATA TRANSFORMATIONS %%%%%%%%%%%%%%%%%%%%%%
    ...
    % 's_theta_81117_h2_std_01.txt', 's_theta_81417_std_h2m_01.txt'
...
%%%%%%%%%%%%%%%%%%%%%%%% TRANSFORMATION AND CONSTANTS %%%%%%%%%%%%%%%%%%%%%
    ...
    for i = 1 : dirs
       ...
       plot(b_saddle_res, s_saddle, c_small(i), 'LineWidth', 4)
       axis([0 10 0 2])
       hold on
       b_res = b_plus(c_new);
       % plot(b_res, s_res, 'Color', cm(i, :))
       plot(b_res, s_res, c_small(i), 'LineWidth', 2)
       ylabel('Front speed $$s$$', 'FontSize', 48)
       xlabel('Biomass $$b_+$$', 'FontSize', 48)
       title('Biomass $$b_+$$ vs. Front speed $$s$$', ...
    ...
    % c = 1
    scatter([2 3 4], [0.7713 0.5114 0.3264], c_small(1), 'LineWidth', 4) % 5, 0.016
    % c = 2
    scatter([2 3 4 5], [0.95416 0.65 0.485 0.39104], c_small(2), 'LineWidth', 4)
    % c = 3
    scatter([2 3 4 5], [1.0837 0.7587 0.5767 0.4637], c_small(3), 'LineWidth', 4) % 2, 1.0837
    % c = 4
    scatter([2 3 4 5], [1.1830 0.8453 0.6481 0.5238], c_small(4), 'LineWidth', 4) % 2, 1.1830
    % c = 5
    scatter([2 3 4 5], [1.362 0.9186 0.7095 0.5759], c_small(5), 'LineWidth', 4) % 2, 1.362
...
%%%%%%%%%%%%%%%%%%%%%%%% REPLOTTING IN S-THETA PLANE %%%%%%%%%%%%%%%%%%%%%%
    ...
    plot(ts_data, 0.25*ts_data.^2, 'b', 'LineWidth', 2); % theta^2 = 4s
    axis([0 3 0 3])
    hold on
