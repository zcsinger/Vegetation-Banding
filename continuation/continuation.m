...
filename = 's_vs_theta_80917_t2.txt';
...
dir_switch = 0.1;   % switch direction after what percentage
...
%%%%%%%%%%%%%%%%%%%%%% TANGENT ARCLENGTH CONTINUATION %%%%%%%%%%%%%%%%%%%%%
    ...
    xlabel('Space x')
    ylabel('Biomass b')
    title(['Space x vs. Biomass b with theta = ' num2str(theta) ...
            ', s = ' num2str(s)])
    hold on
    
    subplot(2, 1, 2)
    plot(s_data, theta_data, 'r')
    xlabel('Front speed s')
    ylabel('Theta')
    title(['Front speed s vs. Theta with theta = ' num2str(theta) ...
             ', s = ' num2str(s)])
